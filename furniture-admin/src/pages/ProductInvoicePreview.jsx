        ...
        "
            >
                ...
                <div className="relative z-10">
                    ...
                    {/* META INFO */}
                    <div className="mt-12 pt-4 border-t border-gray-200 flex justify-between text-xs text-gray-500 pb-2">
                        <div>
                            <div><b>Bill Generated By:</b> {invoice.createdBy?.name || "System"}</div>
                            <div><b>Date & Time:</b> {new Date(invoice.createdAt).toLocaleString("en-IN", {
                        ...
                        <div className="text-right">
                            {lastPayment?.receivedBy?.name && (
                                <div><b>Last Payment Added By:</b> {lastPayment.receivedBy.name}</div>
                            )}
                        </div>
                    </div>
                </div>
